...
"""
@Author:UmeAI
@File:my_entity_alignment_TransE.py
@Time:2022/12/19 10:53
@Read: transE 代码；为了和开源的实体进行对齐
"""
import argparse
...
parser.add_argument(
    ...
    # default='../../datasets/EN_DE_15K_V1/',
    default=r'F:\Documents\NJU_KnowledgeFusionCourseExp\entity_alignment\OpenEA_dataset_v2.0\EN_FR_15K_V1\\',
)
...
parser.add_argument(
    '--embedding_module', type=str, default='MTransE',
    choices=['BasicModel',
...
parser.add_argument('--init', type=str, default='unit', choices=['normal', 'unit', 'xavier', 'uniform'])
...
parser.add_argument('--alpha', type=float, default=1.1)  # For MTransE and KDCoE
