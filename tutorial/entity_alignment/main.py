...
from tutorial.entity_alignment.mtranse import MTransEV2
from tutorial.entity_alignment.utils import read_items, MyKGs
...
parser.add_argument('--mapping_neg_num', type=int, default=1)
